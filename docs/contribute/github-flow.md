<!-- Space: Projects -->
<!-- Parent: Nvimrc -->
<!-- Title: Contributing GithubFlow Nvimrc -->
<!-- Label: Nvimrc -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to nvimrc project on [GitHub](https://github.com/luismayta/nvimrc), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/luismayta/nvimrc/pulls).
...
To follow the instructions in this guide and start contributing to nvimrc project on GitHub:
...
```bash
git remote add upstream  https://github.com/luismayta/nvimrc.git
```

Now your **upstream** points to **luismayta/nvimrc**.
...
All merge requests are automatically tested using [Github Actions](https://github.com/luismayta/nvimrc/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
